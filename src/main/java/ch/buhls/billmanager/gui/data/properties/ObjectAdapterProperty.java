 ...
 * @author simon
 */
public class ObjectAdapterProperty<T> extends ObjectProperty<T> {

    private final IPropertyData<T> data;
    ...
    public ObjectAdapterProperty(IPropertyData<T> data) {
        this.data = data;
    }
    ...
    private static class Listener implements InvalidationListener {
        ...
        private final WeakReference<ObjectAdapterProperty<?>> wref;

        public Listener(ObjectAdapterProperty<?> ref) {
            this.wref = new WeakReference<ObjectAdapterProperty<?>>(ref);
        }

        @Override
        public void invalidated(Observable observable) {
            ObjectAdapterProperty<?> ref = wref.get();
            if (ref == null) {
